...
public class ActorManager {
     ...
     * Warning : it means that the actor can be deleted according to the sweeper
     * method !
     * 
    ...
    /**
     * The class builde is the main part of the pattern Builder. It is used to
     * handle multiple combinaisons of values without beeing required to create a
     * new Actor Manager
     */
    public static class Builder {
        ...
        /**
         * The check interval is used to clean the actors list : each n seconds, all
         * actors with no lifetime left will be deleted
         * 
         ...
         * Beware : if set to false, you'll have to manage each ID by your own and check
         * if they are unique
         * 
    ...
    /**
     * Get the actor Identifier. Maybe used to have the type of actor stocked and
     * managed
     * 
    ...
    /**
     * Get the status of the actor manager : if false, you have to make the actors
     * ID by yourself, if true
